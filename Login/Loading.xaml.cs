...
namespace Dissertation.Views.Login
{
    ...
    public partial class Loading : ContentPage
    {
		...
		private async Task PopulateTablesWithData()
        {
            ...
            var exerciseName1 = new ExerciseName { ExerciseNameString = "Bench Press", ExerciseGroupId = 4 };
            var exerciseName2 = new ExerciseName { ExerciseNameString = "Squat", ExerciseGroupId = 3 };
            var exerciseName3 = new ExerciseName { ExerciseNameString = "Db Shoulder Press", ExerciseGroupId = 6 };
            var exerciseName4 = new ExerciseName { ExerciseNameString = "Deadlift", ExerciseGroupId = 5 };
